...
public class Style_HairBeard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_hair_beard);
        //set title
        setTitle(R.string.hair_and_beard);
        //back button
        ...
        String referenceDBName = "HairBeard_Style";
        //style 1
        //get image_1
