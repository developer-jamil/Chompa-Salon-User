            ...
            FirebaseAuth.getInstance().fetchSignInMethodsForEmail(email)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            boolean isPasswordSet = signInMethods.contains(EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD);
                            ...
                            if (isPasswordSet) {
                                ...
                                Toast.makeText(ChangePassword.this, "Password Not Set", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            // Failed to fetch sign-in methods
                            Toast.makeText(ChangePassword.this, "Failed to retrieve sign-in methods", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
            ...
            if (TextUtils.isEmpty(userCurrentPass)){
                ...
                firebaseUser.reauthenticate(credential).addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()){
                        ...
                        changePass.setOnClickListener(view1 -> changePassPassMethod(firebaseUser));
