...
public class UploadProfileImage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseDatabase.getReference("Registered Users").child("All Users")
                .child(modifiedEmail)
                            ...
                            Picasso.get()
                                    ...
                                    .into(circleImageView, new Callback() {
                                        ...
                                        public void onSuccess() {
                                            // Image successfully loaded, hide the ProgressBar
                                            progressBar.setVisibility(View.GONE);
                                        }

                                        @Override
                                        public void onError(Exception e) {
                                            // Error occurred while loading image, hide the ProgressBar
                                            progressBar.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            this.finish();
            startActivity(new Intent(UploadProfileImage.this, MainActivity.class));
        }
